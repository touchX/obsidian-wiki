---
name: docs-ingest
description: 多格式文档综合摄取引擎。支持 Word/Excel/PDF/Markdown/HTML 等多种格式，MIME 智能检测，旧格式自动转换，Skill 路由分发。当用户提到摄取文档、导入资料、处理 raw 目录文件、将文档加入知识库、整理资料到 wiki、导入网页、处理 URL 时必须使用。核心能力：1 个源文件 → N 个 wiki 页面的知识综合。
---
