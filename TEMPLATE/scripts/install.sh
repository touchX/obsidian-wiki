...
install_skill "learning-tracker/learning-tracker.sh" "$PROJECT_DIR/.claude/skills/learning-tracker/learning-tracker.sh"
install_skill "learning-tracker/analyzer.sh" "$PROJECT_DIR/.claude/skills/learning-tracker/analyzer.sh"
mkdir -p "$PROJECT_DIR/.claude/skills/learning-tracker/config"
install_skill "config/user-activity.json.base" "$PROJECT_DIR/.claude/skills/learning-tracker/config/user-activity.json.base"
